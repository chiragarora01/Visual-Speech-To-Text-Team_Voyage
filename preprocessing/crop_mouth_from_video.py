...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--video-direc', default=r'E:\test set\lipread_mp4', help='raw video directory')
    parser.add_argument('--landmark-direc', default=r'C:\Users\panda\Lipreading_using_Temporal_Convolutional_Networks\landmarks\LRW_landmarks', help='landmark directory')
    parser.add_argument('--filename-path', default='./lrw500_detected_face.csv',
                        help='list of detected video and its subject ID')
    parser.add_argument('--save-direc', default=r'D:\output', help='the directory of saving mouth ROIs')
    # -- mean face utils
